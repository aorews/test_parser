...
def test_login_with_password(path_to_session):
    instagram_login = os.getenv("INST_LOGIN")
    instagram_pass = os.getenv("INST_PASS")

    InstagramSession(instagram_login, instagram_pass, path_to_session).login_with_password()

def test_login_from_session(path_to_session):
    instagram_login = os.getenv("INST_LOGIN")
    InstagramSession(instagram_login, "", path_to_session).login_from_session(instagram_login, path_to_session)
